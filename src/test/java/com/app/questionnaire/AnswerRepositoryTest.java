...
public class AnswerRepositoryTest {
	...
	@Test
	public void createNewAnswer_userShouldBeCorrect() {
		
		User user7 = new User(null, "user", "$2a$06$3jYRJrg0ghaaypjZ/.g4SethoeA51ph3UD4kZi9oPkeMTpjKU5uo6", "USER","pm@gmail.com");
		uRepository.save(user7);
		
		User user8 = new User(null, "user", "$2a$06$3jYRJrg0ghaaypjZ/.g4SethoeA51ph3UD4kZi9oPkeMTpjKU5uo6", "USER","pm@gmail.com");
		...
		assertEquals(user7, foundedAnswer1.get().getQuestion().getQuestionnaire().getUser());
	}
